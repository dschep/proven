SOURCES := template.js icons/facebook.svg icons/generic_web_site.svg icons/github.svg icons/hackernews.svg icons/keybase.svg icons/reddit.svg icons/twitter.svg icons/mastodon.svg icons/unknown.svg
